...
public class StudentReg extends Fragment
{
    ...
    public void init(View v)
    {
        ...
        fname=(EditText)v.findViewById(R.id.s_fname);
        lname=(EditText)v.findViewById(R.id.s_lname);
        username=(EditText)v.findViewById(R.id.s_username);
        password=(EditText)v.findViewById(R.id.s_password);
        confirmpassword=(EditText)v.findViewById(R.id.s_conpassword);
        age=(EditText)v.findViewById(R.id.s_age);
        emailid=(EditText)v.findViewById(R.id.s_emailid);
        phone=(EditText)v.findViewById(R.id.s_phone);
        male=(RadioButton)v.findViewById(R.id.s_male);
        female=(RadioButton)v.findViewById(R.id.s_female);
        dob=(TextView)v.findViewById(R.id.s_dob);
        signup=(Button)v.findViewById(R.id.s_signup);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.studentreg, container, false);
        init(rootView);
    ...
    public void uploadStudent()
    {
        ...
        server.setOnServerStatusListner(new ServerConnector.OnServerStatusListner()
        {
            ...
            public void onServerResponded(String responce)
            {
                if (responce.length()==4)
                {
                    ...
                    alert.setMessage("Successfully registered account");
                    alert.show();
                }
                else
                {
        ...
        server.connectServer("http://leomessi10.esy.es/signup.php?fname="+fname.getText().toString()+"&lname="+lname.getText().toString()+"&username="+username.getText().toString()+"&password="+password.getText().toString()+"&who=student&dob="+dob.getText().toString()+"&age="+age.getText().toString()+"&gender="+gender+"&email="+emailid.getText().toString()+"&phone="+phone.getText().toString()+"&branch="+branch.getSelectedItem().toString()+"&sem="+sem.getSelectedItem().toString());
    }
